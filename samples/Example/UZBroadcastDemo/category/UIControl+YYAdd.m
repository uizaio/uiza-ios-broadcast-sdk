...
@interface _UZUIControlBlockTarget : NSObject
...
@implementation _UZUIControlBlockTarget
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
    ...
    _UZUIControlBlockTarget *target = [[_UZUIControlBlockTarget alloc]
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    [targets enumerateObjectsUsingBlock: ^(id obj, NSUInteger idx, BOOL *stop) {
        _UZUIControlBlockTarget *target = (_UZUIControlBlockTarget *)obj;
