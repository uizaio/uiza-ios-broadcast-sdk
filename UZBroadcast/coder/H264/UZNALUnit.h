...
public:
    UZNALUnit();
    UZNALUnit(const BYTE* pStart, int len){
    ...
    UZNALUnit(const UZNALUnit &r){
        m_pStart = r.m_pStart;
        m_cBytes = r.m_cBytes;
        ResetBitstream();
    }
    const UZNALUnit& operator = (const UZNALUnit &r)
    {
        m_pStart = r.m_pStart;
        m_cBytes = r.m_cBytes;
        ResetBitstream();
...
{
public:
    UZavcCHeader(const BYTE* header, int cBytes);
    UZNALUnit *sps() {
        return &m_sps;
    }
