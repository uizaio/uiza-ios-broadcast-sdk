...
#import "UZVideoEncoder.h"

@implementation UZVideoEncoder
{
...
+ (UZVideoEncoder *)encoderForPath:(NSString *)path Height:(int)height andWidth:(int)width bitrate:(int)bitrate {
    UZVideoEncoder *enc = [UZVideoEncoder alloc];
