...
@interface UZVideoCapture : NSObject
...
@property (nullable, nonatomic, weak) id<UZVideoCaptureDelegate> delegate;
...
/**
   ...
   capture unstable.
 */
- (nullable instancetype)initWithVideoConfiguration:(nullable UZVideoConfiguration *)configuration NS_DESIGNATED_INITIALIZER;
