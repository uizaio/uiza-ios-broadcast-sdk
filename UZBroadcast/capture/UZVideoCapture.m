...
@interface UZVideoCapture ()

@property (nonatomic, strong) GPUImageVideoCamera *videoCamera;
@property (nonatomic, strong) UZGPUImageBeautyFilter *beautyFilter;
...
- (instancetype)initWithVideoConfiguration:(UZVideoConfiguration *)configuration {
    if (self = [super init]) {
...
- (void)reloadFilter{
    ...
    if (self.beautyFace) {
        self.output = [[UZGPUImageEmptyFilter alloc] init];
        self.filter = [[UZGPUImageBeautyFilter alloc] init];
        self.beautyFilter = (UZGPUImageBeautyFilter*)self.filter;
    } else {
        self.output = [[UZGPUImageEmptyFilter alloc] init];
        self.filter = [[UZGPUImageEmptyFilter alloc] init];
    ...
    /// 480*640 ratio is 4:3 forced conversion to 16:9
