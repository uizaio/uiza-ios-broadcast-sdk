...
NSString *const UZAudioComponentFailedToCreateNotification = @"UZAudioComponentFailedToCreateNotification";

@interface UZAudioCapture ()

@property (nonatomic, assign) AudioComponentInstance componetInstance;
@property (nonatomic, assign) AudioComponent component;
@property (nonatomic, strong) dispatch_queue_t taskQueue;
@property (nonatomic, assign) BOOL isRunning;
@property (nonatomic, strong,nullable) UZAudioConfiguration *configuration;

@end

@implementation UZAudioCapture

#pragma mark -- LiftCycle
- (instancetype)initWithAudioConfiguration:(UZAudioConfiguration *)configuration{
    if(self = [super init]){
...
- (void)handleAudioComponentCreationFailure {
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:UZAudioComponentFailedToCreateNotification object:nil];
    });
}
...
static OSStatus handleInputBuffer(void *inRefCon,
    ...
    @autoreleasepool {
        UZAudioCapture *source = (__bridge UZAudioCapture *)inRefCon;
        if (!source) return -1;
